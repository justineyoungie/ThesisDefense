...
public class Wizard extends Ally{
    ...
    public Wizard(int posX, int poxY, int indexX, int indexY, Bitmap image, float scale, boolean isWizard) {
        super(posX, poxY, 5, 1, 1000, indexX, indexY, image, scale, 1, 4, 3);
